...
// Crash input:
// \000\001\001\003\220\000\001\001\003\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000
...
int main() {
    ...
    uint8_t crash_data[] = {0x00, 0x01, 0x01, 0x03, 0x90, 0x00, 0x01, 0x01, 0x03, 0x00, 0x00, 0x00, 0x00,
    ...
    for (size_t i = 8; i + 9 <= sizeof(crash_data); i += 9) {
        ...
        ops.push_back(op);
        std::cout << "Op[" << ops.size() - 1 << "]: code=" << op.code << " (cmd=" << (op.code % 12) << ")"
