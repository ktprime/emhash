...
using map5  = emhash5::HashMap<K, V, H>;
template <typename K, typename V, typename H = std::hash<K>>
using map6  = emhash6::HashMap<K, V, H>;
template <typename K, typename V, typename H = std::hash<K>>
using map7  = emhash7::HashMap<K, V, H>;
template <typename K, typename V, typename H = std::hash<K>>
using map8  = emhash8::HashMap<K, V, H>;
template <typename K, typename V, typename H = std::hash<K>>
using imap1 = emilib::HashMap<K, V, H>;
template <typename K, typename V, typename H = std::hash<K>>
using imap2 = emilib2::HashMap<K, V, H>;
template <typename K, typename V, typename H = std::hash<K>>
using imap3 = emilib3::HashMap<K, V, H>;

// ============================================================================
// Unified set aliases (all HashSet<K, HashT, EqT>)
// ============================================================================
template <typename K, typename H = std::hash<K>>
using set2  = emhash2::HashSet<K, H>;
template <typename K, typename H = std::hash<K>>
using set4  = emhash4::HashSet<K, H>;
template <typename K, typename H = std::hash<K>>
using set8  = emhash8::HashSet<K, H>;
template <typename K, typename H = std::hash<K>>
using iset2 = emilib2::HashSet<K, H>;
template <typename K, typename H = std::hash<K>>
using iset3 = emilib3::HashSet<K, H>;
...
#define AllIntMaps map5<int, int>, map6<int, int>, map7<int, int>, map8<int, int>, \
    imap1<int, int>, imap2<int, int>, imap3<int, int>

// All 7 map implementations with std::string->int (covers emilib gap)
#define AllStringMaps map5<std::string, int>, map6<std::string, int>, map7<std::string, int>, map8<std::string, int>, \
...
#define AllStringSets set2<std::string>, set4<std::string>, set8<std::string>, \
    iset2<std::string>, iset3<std::string>
