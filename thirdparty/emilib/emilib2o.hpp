...
public:
    ...
    private:
        void goto_next_element()
        {
            ...
            do {
                _bmask = _map->filled_mask(_from += ITERATOR_BITS);
            } while (_bmask == 0);
