...
- Deletion requires care (handled differently per version: emhash7 uses no-tombstone linked-bucket chain repair; emhash5/6/8 use bucket chain or backshift deletion)
